...
// configuration step. It creates a namespace called `category_theorie`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", category_theorie::cmake::project_name, category_theorie::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", category_theorie::cmake::project_version);
      return EXIT_SUCCESS;
    }
